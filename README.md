...
In order to run this project you need: https://github.com/PrantoshB/Awesome-Books.git
...
- On the terminal run this command git clone https://github.com/PrantoshB/Awesome-Books.git
...
Feel free to check the [issues page] (https://github.com/PrantoshB/Awesome-Books/issues)
